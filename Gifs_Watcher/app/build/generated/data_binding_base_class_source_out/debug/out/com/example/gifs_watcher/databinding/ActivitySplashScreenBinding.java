...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView splashscreenBackground;

  private ActivitySplashScreenBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView splashscreenBackground) {
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.splashscreen_background;
      ImageView splashscreenBackground = ViewBindings.findChildViewById(rootView, id);
      if (splashscreenBackground == null) {
        break missingId;
      }

      return new ActivitySplashScreenBinding((ConstraintLayout) rootView, splashscreenBackground);
    }
