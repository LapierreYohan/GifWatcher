...
class MainViewModel : ViewModel() {
    ...
    private val u1 = User("id1", "nek1oux", "Nek1oux", "pwd1", "user1@example.com", "Bio de l'utilisateur 1", "03/12/1990", "https://media1.tenor.com/m/z2FuWLCu0MsAAAAC/merry-christmas.gif")
    ...
    private val u3 = User("id3", "aizen", "Aizen", "pwd3", "user3@example.com", "Bio de l'utilisateur 3", "20/04/1993", "https://media1.tenor.com/m/z2FuWLCu0MsAAAAC/merry-christmas.gif")
    private val u4 = User("id4", "elix", "Elix", "pwd4", "user4@example.com", "Bio de l'utilisateur 4", "07/09/1988", "https://media1.tenor.com/m/z2FuWLCu0MsAAAAC/merry-christmas.gif")
    private val u5 = User("id5", "nekfeu", "Nekfeu", "pwd5", "user5@example.com", "Bio de l'utilisateur 5", "11/02/1996", "https://media1.tenor.com/m/z2FuWLCu0MsAAAAC/merry-christmas.gif")
    private val u6 = User("id6", "oli", "Oli", "pwd6", "user6@example.com", "Bio de l'utilisateur 6", "25/11/1980", "https://media1.tenor.com/m/z2FuWLCu0MsAAAAC/merry-christmas.gif")
    private val u7 = User("id7", "urahara", "Urahara", "pwd7", "user7@example.com", "Bio de l'utilisateur 7", "15/09/1992", "https://media1.tenor.com/m/z2FuWLCu0MsAAAAC/merry-christmas.gif")
    ...
    private val u9 = User("id9", "modo", "Modo", "pwd9", "user9@example.com", "Bio de l'utilisateur 9", "18/03/1995", "https://media1.tenor.com/m/z2FuWLCu0MsAAAAC/merry-christmas.gif")
    private val u10 = User("id10", "beluga", "Beluga", "pwd10", "user10@example.com", "Bio de l'utilisateur 10", "30/08/1983", "https://media1.tenor.com/m/z2FuWLCu0MsAAAAC/merry-christmas.gif")
    ...
    private val u12 = User("id12", "alex", "Alex", "pwd12", "user12@example.com", "Bio de l'utilisateur 12", "05/04/1982", "https://media1.tenor.com/m/z2FuWLCu0MsAAAAC/merry-christmas.gif")
